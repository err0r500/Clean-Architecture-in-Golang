...
func TestFlow(t *testing.T) {
	...
	log.Print("===========")
	tI := useCases.NewUserInteractor(domain.DummyChecker{}, domain.DummyChecker{}, useCases.DummyUserReadWriter{})
	tI.UseCase1(nil)
	...
	log.Print("===========")
	tI2 := useCases.NewUserInteractor(domain.DummyChecker{}, interfaces.RealChecker{}, interfaces.RealUserReadWriter{})
	tI2.UseCase1("hoho")
	tI2.UseCase2(12345)
	log.Print("===========\n\n\n")
